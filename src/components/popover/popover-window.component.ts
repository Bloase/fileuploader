...
import { PopoverWindowOptions } from './popover-options.service';
            ...
            <div class="row">
              <div
                ...
                *ngIf="!options.hideConfirmButton">
                <button
                  [bloaseFocus]="options.focusButton === 'confirm'"
              ...
              <div
                ...
                *ngIf="!options.hideCancelButton">
                <button
                  [bloaseFocus]="options.focusButton === 'cancel'"
  ...
  export class PopoverWindow implements AfterViewInit {
