import { Directive, Input, Output, EventEmitter, HostListener, ViewContainerRef, ComponentRef, OnDestroy, ElementRef, OnChanges, OnInit, ReflectiveInjector, ResolvedReflectiveProvider, ComponentFactoryResolver, Injector, Inject, Renderer2, TemplateRef, ComponentFactory } from '@angular/core';
import { DOCUMENT } from '@angular/platform-browser';
import { PopoverWindow } from './popover-window.component';
import { PopoverOptions, PopoverWindowOptions } from './popover-options.service';
import { Positioning } from './positioning';
  ...
  export class ConfirmationPopover implements OnDestroy, OnChanges, OnInit {
     ...
     * ```
     *
     * Then pass customTemplate to the ConfirmationPopover directive like so `[customTemplate]="customTemplate"`
     */
     ...
     * @private
     */
    popover: ComponentRef<PopoverWindow> = null;
    ...
    private showPopover(): void {
      if (!this.popover && !this.isDisabled) {
        ...
        const options: PopoverWindowOptions = new PopoverWindowOptions();
        ...
        const componentFactory: ComponentFactory<PopoverWindow> = this.cfr.resolveComponentFactory(PopoverWindow);
